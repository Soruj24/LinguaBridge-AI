import type { LoginNotificationData } from "./securityNotificationTypes";
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f5f5f5; padding: 40px 20px;">
          <div style="max-width: 480px; margin: 0 auto; background: white; border-radius: 16px; padding: 40px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin-top: 32px;">
              <a href="${baseUrl}/security" style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, hsl(var(--primary)), hsl(var(--primary) / 0.8)); color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">Secure Your Account</a>
            </div>
