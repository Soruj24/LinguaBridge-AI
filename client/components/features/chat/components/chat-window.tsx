...
import { useChat } from "@/components/features/chat/hooks/use-chat";
import {
  ChatSearch,
  ChatInfoDialog,
} from "@/components/features/chat/components";
import { ChatWindowHeader } from "@/components/features/chat/components/chat-header";
import { ChatMessageList } from "@/components/features/chat/components/chat-messages";
import { ChatInputArea } from "@/components/features/chat/components/chat-input";
import { ClearChatDialog } from "@/components/features/chat/components/chat-clear-dialog";
import { ForwardDialog } from "@/components/features/chat/components/chat-forward-dialog";
import { PhrasebookDrawer } from "@/components/features/phrasebook/components/phrasebook-drawer";
