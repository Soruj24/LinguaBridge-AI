...
import { Globe, Home, ArrowLeft, MessageSquare } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link href="/en/login" className="text-sm text-primary hover:text-primary/80 transition-colors flex items-center gap-1">
              <ArrowLeft className="h-3 w-3" />
              Sign In
            </Link>
            <Link href="/en/register" className="text-sm text-primary hover:text-primary/80 transition-colors flex items-center gap-1">
              <MessageSquare className="h-3 w-3" />
              Create Account
            </Link>
            <Link href="/en/dashboard" className="text-sm text-primary hover:text-primary/80 transition-colors flex items-center gap-1">
